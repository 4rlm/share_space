...
#Create bookings
3.times do
  Booking.create({start_date: (Date.today + 2).to_datetime,end_date:  (Date.today + 3).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 4).to_datetime,end_date:  (Date.today + 5).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 6).to_datetime,end_date:  (Date.today + 7).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 8).to_datetime,end_date:  (Date.today + 9).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 10).to_datetime,end_date:  (Date.today + 11).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 12).to_datetime,end_date:  (Date.today + 13).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 14).to_datetime,end_date:  (Date.today + 15).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 16).to_datetime,end_date:  (Date.today + 17).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 18).to_datetime,end_date:  (Date.today + 19).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 20).to_datetime,end_date:  (Date.today + 21).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 22).to_datetime,end_date:  (Date.today + 23).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 24).to_datetime,end_date:  (Date.today + 25).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 26).to_datetime,end_date:  (Date.today + 27).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 28).to_datetime,end_date:  (Date.today + 29).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 30).to_datetime,end_date:  (Date.today + 31).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 32).to_datetime,end_date:  (Date.today + 33).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 34).to_datetime,end_date:  (Date.today + 35).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 36).to_datetime,end_date:  (Date.today + 37).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
  Booking.create({start_date: (Date.today + 38).to_datetime,end_date:  (Date.today + 39).to_datetime, desk_id: Desk.all.sample.id,  user_id: User.all.sample.id})
end
