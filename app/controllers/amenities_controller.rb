class AmenitiesController < ApplicationController
  ...
  private
    ...
    def amenity_params
      params.require(:amenity).permit(:accessibility, :bike_rack, :coffee, :computer, :kitchen, :locked_door, :monitor, :parking, :pet_friendly, :phone, :price, :printer, :shower, :tv, :wifi)
    end
end
